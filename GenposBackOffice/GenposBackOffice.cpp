// GenposBackOffice.cpp : Defines the class behaviors for the application.
//
...
// CGenposBackOfficeApp construction

CGenposBackOfficeApp::CGenposBackOfficeApp()
{
	EnableHtmlHelp();
...
// The one and only CGenposBackOfficeApp object

CGenposBackOfficeApp theApp;


// CGenposBackOfficeApp initialization

BOOL CGenposBackOfficeApp::InitInstance()
{
...
void CGenposBackOfficeApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
