...
BEGIN_MESSAGE_MAP(CDialogCashierEdit, CDialog)
	ON_NOTIFY(TCN_SELCHANGE, IDC_TAB_CASHIER_EDIT_STATUS, &CDialogCashierEdit::OnTcnSelchangeTabCashierEditStatus)
	ON_NOTIFY(TCN_SELCHANGING, IDC_TAB_CASHIER_EDIT_STATUS, &CDialogCashierEdit::OnTcnSelchangingTabCashierEditStatus)
END_MESSAGE_MAP()
...
void CDialogCashierEdit::OnTcnSelchangeTabCashierEditStatus(NMHDR *pNMHDR, LRESULT *pResult)
{
	*pResult = 0;
...
void CDialogCashierEdit::OnTcnSelchangingTabCashierEditStatus(NMHDR *pNMHDR, LRESULT *pResult)
{
	*pResult = 0;
	int i = TabCtrl_GetCurSel(pNMHDR->hwndFrom);
